...
En los resultados obtenidos, se puede observar el uso de la reducción de la dimensionalidad en el ahorro de almacenamiento, evitando comprometer la calidad de la imagen.
Se encuentra demostrado posteriormente, que al aumentar la cantidad de espacio ahorrado, la cantidad de componentes principales disminuye,
causando una disminución en la calidad visual.
\end{abstract}
